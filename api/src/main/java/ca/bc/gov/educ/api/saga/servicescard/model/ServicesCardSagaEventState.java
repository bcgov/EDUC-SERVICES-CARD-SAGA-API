package ca.bc.gov.educ.api.saga.servicescard.model;
...
@Data
@Entity
@Table(name = "SERVICES_CARD_SAGA_EVENT_STATES")
@DynamicUpdate
public class ServicesCardSagaEventState {
  ...
  private ServicesCardSaga servicesCardSaga;
